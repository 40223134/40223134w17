...
class Hello(object):
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def mygeartest(self, N=15,O=24, M=15, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    齒數1:<br />
        <select name="N">
        '''
        for s in range(15,81):
            outstring+=''' <option value="'''+str(s)+'''">'''+str(s)+'''</option>'''
        outstring+='''
        </select><br/>
    ...
    齒數2:<br />
        <select name="O">
        '''
        for z in range(15,81):
            outstring+='''<option value="'''+str(z)+'''">'''+str(z)+'''</option>'''
        outstring+='''
       </select><br/>
    <input type=submit value=send>
    </form>
